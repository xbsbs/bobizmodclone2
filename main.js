...
conn.welcome = '*┌─❖  │「 مرحبا👋 」 /n└┬❖:// instagram.com/noureddine_ou 「 @${xeonName.split("@")[0]}  」    /n│✑  𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼    /n │✑  𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 ( 𝗞𝗔𝗩𝗘𝗘𝗦𝗛𝗔 )   /n│✑ ${metadata.subject}   /n │✑  𝗠𝗲𝗺𝗯𝗲𝗿 :   /n│✑ ${xmembers}th   /n│✑  𝗝𝗼𝗶𝗻𝗲𝗱 :  /n │✑ ${xtime} ${xdate}  /n  └───────────────┈ ⳹` let buttons = [ {buttonId: `wkwwk`, buttonText: {displayText: 'Welcome 🎲'}, type: 1}  ]*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ مع السلامه الي يخرج كلب والي يدخل 🦁 👋🏻* \n*╚══════════════*'
...
let bio = `🤖اللهـم اجل صنعي حسنه المهم طفي اي بوت يسوي في محرمات/تحت الامبراطور انوس 🙂`
