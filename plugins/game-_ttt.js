...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} ربحت 🥳, تحصل علي +4999 نقاط خبره` : isTie ? 'المباراه النهائيه متعادله 😐' : `دور @${room.game.currentTurn.split('@')[0]}`}
`.trim()
